...
export default function AgentDetail({ id }: AgentDetailProps) {
  ...
  const handleRegenerateKey = async () => {
    if (!confirm('Are you sure you want to regenerate the machine key? This will disconnect any currently connected agent.')) {
      return
    }
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="space-x-2">
                    <Button 
                      variant="outline" 
                      size="sm"
                      onClick={() => agent.machineKey && handleCopy(agent.machineKey, 'Machine key')}
                    >
