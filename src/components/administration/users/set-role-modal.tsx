  ...
  const userRoles = useMemo(() => {
    ...
    return (user.roles || []).map((roleName: string) => {
      ...
      return role
        ...
        : { id: roleName, name: roleName, description: '' }
    })
      ...
      <DialogContent className="max-w-[700px]">
        ...
        <div className="flex gap-2 items-end mb-4">
          ...
          <Button
            ...
            disabled={!selectedRoleId || isLoading || isUserRolesLoading}
            type="button"
          >
            Add
          </Button>
          ...
          <Table className="min-w-full table-fixed">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="w-1/3 text-left max-w-[200px] truncate">
                  Description
                </TableHead>
