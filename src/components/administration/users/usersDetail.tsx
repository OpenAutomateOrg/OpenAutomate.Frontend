...
export default function UsersDetail({ id }: UsersDetailProps) {
  const router = useRouter()
  const [agent, setExcution] = useState<UsersRow | null>(null)

  useEffect(() => {
    // TODO: Replace with actual API call
    const mockExcution: UsersRow = {
      id,
      name: 'Excution 2',
