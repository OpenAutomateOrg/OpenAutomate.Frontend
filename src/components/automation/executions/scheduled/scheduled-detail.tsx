      ...
      <Card className="border rounded-md shadow-sm">
            ...
            <div>
              <h1 className="text-xl font-semibold">
                {packageName ||
                  ...
                  `${t('executions.detail.package')} ${execution.packageId?.substring(0, 8)}` ||
                  t('executions.detail.scheduledExecution')}
              </h1>
            </div>
          </div>
        ...
        <CardContent className="p-6 space-y-6">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <DetailBlock label={t('executions.detail.scheduledTime')} icon={Clock}>
                  ...
                  <DetailBlock label={t('executions.detail.timeUntilExecution')} icon={Clock}>
                    {execution.startTime
                      ? (() => {
                          const now = Date.now()
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <DetailBlock label={t('executions.detail.executionType')} icon={CheckCircle}>
                  <Badge variant="outline">Scheduled</Badge>
                </DetailBlock>
                <DetailBlock label={t('executions.detail.priority')} icon={CheckCircle}>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <DetailBlock label={t('executions.detail.created')} icon={Calendar}>
                  {formatUtcToLocal(execution.startTime, {
                    dateStyle: 'full',
                    timeStyle: 'medium',
                    fallback: 'N/A',
                ...
                <DetailBlock label={t('executions.detail.expectedDuration')} icon={Clock}>
