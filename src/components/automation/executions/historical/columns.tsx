...
interface UseHistoricalColumnsProps {
  onDeleted?: () => void
}

export function useHistoricalColumns({
  onDeleted,
}: UseHistoricalColumnsProps = {}): ColumnDef<ExecutionsRow>[] {
  const { t } = useLocale()
  ...
  return [
    ...
    },
    {
      id: 'actions',
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t('executions.columns.actions')} />
      ),
    ...
    },
    {
      accessorKey: 'Version',
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t('executions.columns.packageVersion')} />
      ),
      cell: ({ row }) => (
        <div className="flex items-center">
    ...
    },
    {
      accessorKey: 'state',
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t('executions.columns.state')} />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t('executions.columns.startTime')} />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      accessorKey: 'endTime',
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t('executions.columns.endTime')} />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      accessorKey: 'source',
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t('executions.columns.source')} />
      ),
      cell: ({ row }) => (
        <div className="flex items-center">
    ...
    },
    {
      accessorKey: 'command',
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t('executions.columns.command')} />
      ),
      cell: ({ row }) => (
        <div className="flex items-center">
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t('executions.columns.schedules')} />
      ),
      cell: ({ row }) => (
        <div className="flex items-center">
    ...
    },
    {
      accessorKey: 'taskId',
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t('executions.columns.taskId')} />
      ),
      cell: ({ row }) => (
        <div className="flex items-center">
...
export const createColumns = useHistoricalColumns
